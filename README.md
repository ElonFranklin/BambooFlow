...
**Local network file sharing & instant messaging — no internet required.**

BambooFlow is a lightweight tool for your WiFi network. Share files **and** chat with other devices in real time — no cloud services, no USB drives, no internet. Just start the server, scan the QR code, and you're connected.
...
- 💬 **LAN Chat Room** — Real-time instant messaging between all connected devices
- 📁 **File Sharing** — Drag & drop upload, up to 1GB per file
- 📱 **QR Code** — Scan with your phone to connect instantly
- 🔔 **Live Notifications** — WebSocket alerts for new messages and files
...
BambooFlow is designed for **trusted local networks only** (home, office, lab). It has **no authentication mechanism** — anyone on the same WiFi can send messages and transfer files. Do not expose it to the public internet.
